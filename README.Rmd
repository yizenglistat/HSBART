---
title: "Soft Bayesian Additive Models"
...
- New Markov transistions are used, including sampling a tree from the prior and using a type of "Perturb" move due to Pratola (2016, Bayesian Analysis). This has substantial benefits for the mixing of the chain.
